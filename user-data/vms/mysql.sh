...
#
# Mario Aja Moral
# Plantilla script para configurar el servidor MySQL BBDD
...
# MySQL User Creation for mysql2 connection as slave
...
sleep 40
# Get data from mysql2, now the new master
...
# Makes this vm a slave for mysql2
mysql -u root <<SQL
CHANGE MASTER TO
